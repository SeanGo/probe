...
int connect_db(const char* host, const char* user, const char* passwd)
{
#ifdef _SEAN_DEBUG_
    printf("connect_db ..... ");
#endif //_SEAN_DEBUG_
    ...
    if (mysql_real_connect(mysql, host, user, passwd, NULL, 0, NULL, 0) == NULL) 
    {
        fprintf(stderr, "%s\n", mysql_error(mysql));
        mysql_close(mysql);
        exit(2001);
...
#ifdef _SEAN_DEBUG_
	printf("stub_print_memory_stats\n");
#endif //_SEAN_DEBUG_
...
#ifdef _SEAN_DEBUG_
	printf("stub_print_ktables_stats\n");
#endif //_SEAN_DEBUG_
...
{
#ifdef _SEAN_DEBUG_
	printf("print_avg_ktables_stats\n");
#endif //_SEAN_DEBUG_
...
#ifdef _SEAN_DEBUG_
	printf("stub_print_net_sock_stats\n");
#endif //_SEAN_DEBUG_
...
{
#ifdef _SEAN_DEBUG_
	printf("print_avg_net_sock_stats\n");
#endif //_SEAN_DEBUG_
...
#ifdef _SEAN_DEBUG_
	printf("stub_print_net_sock6_stats\n");
#endif //_SEAN_DEBUG_
...
{
#ifdef _SEAN_DEBUG_
	printf("print_avg_net_sock6_stats\n");
#endif //_SEAN_DEBUG_
...
#ifdef _SEAN_DEBUG_
	printf("stub_print_pwr_cpufreq_stats\n");
#endif //_SEAN_DEBUG_
...
{
#ifdef _SEAN_DEBUG_
	printf("print_pwr_cpufreq_stats\n");
#endif //_SEAN_DEBUG_
...
{
#ifdef _SEAN_DEBUG_
	printf("print_avg_pwr_cpufreq_stats\n");
#endif //_SEAN_DEBUG_
...
#ifdef _SEAN_DEBUG_
	printf("stub_print_pwr_fan_stats\n");
#endif //_SEAN_DEBUG_
...
{
#ifdef _SEAN_DEBUG_
	printf("print_avg_pwr_fan_stats\n");
#endif //_SEAN_DEBUG_
...
#ifdef _SEAN_DEBUG_
	printf("stub_print_pwr_temp_stats\n");
#endif //_SEAN_DEBUG_
...
{
#ifdef _SEAN_DEBUG_
	printf("print_avg_pwr_temp_stats\n");
#endif //_SEAN_DEBUG_
...
#ifdef _SEAN_DEBUG_
	printf("stub_print_pwr_in_stats\n");
#endif //_SEAN_DEBUG_
...
#ifdef _SEAN_DEBUG_
	printf("print_pwr_wghfreq_stats\n");
#endif //_SEAN_DEBUG_
...
#ifdef _SEAN_DEBUG_
	printf("stub_print_pwr_usb_stats\n");
#endif //_SEAN_DEBUG_
...
{
#ifdef _SEAN_DEBUG_
	printf("print_avg_pwr_usb_stats\n");
#endif //_SEAN_DEBUG_
...
#ifdef _SEAN_DEBUG_
	printf("stub_print_filesystem_stats\n");
#endif //_SEAN_DEBUG_
...
{
#ifdef _SEAN_DEBUG_
	printf("print_avg_filesystem_stats\n");
#endif //_SEAN_DEBUG_
